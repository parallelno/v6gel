...
echo.
echo === samples/08_sprite_anim: Build script ================================
...
echo.
echo === samples/08_sprite_anim/build.bat: Linking =================================
...
echo.
echo === samples/08_sprite_anim/build.bat: Run the ROM in the emulator ============
